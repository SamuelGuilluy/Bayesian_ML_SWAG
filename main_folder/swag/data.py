...
## function to use the http://mi.eng.cam.ac.uk/research/projects/VideoRec/CamVid/ datasets
def camvid_loaders(path, batch_size, num_workers, transform_train, transform_test, use_validation, val_size, shuffle_train=True, joint_transform=None, ft_joint_transform=None, ft_batch_size=1, **kwargs):
...
## use of torchvision.datasets in order to load the data
def loaders(dataset, path, batch_size, num_workers, transform_train, transform_test, use_validation=True, val_size=5000, split_classes=None, shuffle_train=True, **kwargs):
    if dataset == "NLP":
        num_classes = 4
        return (
        {
