...
dictionnary_arguments = {
    ...
    "dir": r"D:\dossier important 2020\swa_gaussian-master\results",
    "seed": 1,
...
start_epoch = 0
utils.save_checkpoint(args.dir, start_epoch, state_dict=model_NLP.state_dict(), optimizer=optimizer.state_dict())
...
print(df)
path = "D:\\dossier important 2020\\swa_gaussian-master\\optimizer_results\\" + "SWAG_Yelp_Review" + ".csv"
